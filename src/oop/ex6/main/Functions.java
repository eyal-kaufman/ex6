...
public class Functions extends Block {
	...
	/**
	 * updates the variable block map with given line of oop.ex6.variables, when creating new methods.
	 *
	 * @param lineType an object wrap line of javas and its purpose.
	 * @throws VariableException if one of the oop.ex6.variables is not valid.
	 */
